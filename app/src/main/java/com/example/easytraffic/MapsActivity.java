...
import com.example.easytraffic.databinding.ActivityMapsBinding;
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    String[] stringLat = databaseLatitudeString.split(", ");    //array of string of latitude
                    ...
                    mMap.addMarker(new MarkerOptions().position(latLng).title(latitude + " , " + longitude));   //show on the map
